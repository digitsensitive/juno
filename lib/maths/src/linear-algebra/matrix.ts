...
export class Matrix {
   ...
   */
  public setNumberOfRows(r: number): void {
    this.rows = r;
  }
   ...
   */
  public setNumberOfColumns(c: number): void {
    this.columns = c;
  }
   ...
   * @param y
   */
  public setEntryAt(value: number, m: number, n: number): void {
    if (this.isValidPosition(m, n)) {
   ...
   */
  public getDiagnonalEntries(): number[] {
    let counter = 0;
    let diagonalEntries = [];
   ...
   */
  public getOffDiagonalEntries(): number[] {
   ...
   * ```
   */
  public getTransposedMatrix(): Matrix {
   ...
   * ```
   */
  public isDiagonalMatrix(): boolean {
   ...
   * ```
   */
  public isSymmetricMatrix(): boolean {
    if (
   ...
   * ```
   */
  public isAntisymmetricMatrix(): boolean {
   ...
   */
  public getCopy(): Matrix {
    let copiedEntries: number[][] = [];
